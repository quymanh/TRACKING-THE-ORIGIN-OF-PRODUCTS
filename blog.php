          ...
          <div class="col-lg-4 text-left">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                <?php
                $result = mysqli_query(openConnection(), "SELECT posts.posts_name,posts.url,posts.noi_dung,posts.id_users,posts.date,posts.thumbnail,users.username,users.role FROM users JOIN posts ON posts.id_users = users.username WHERE users.role = '0' order by rand() limit 5");
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ?>
