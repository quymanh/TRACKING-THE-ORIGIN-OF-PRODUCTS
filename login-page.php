  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="maincard3">
            ...
            <label type="text" class="formlabel" style="margin-top: 10px;"> Xác nhận Mật khẩu </label>
            ...
            <button class="formbtn" name="loginsubmit" value="submitted!" type="submit">Đăng ký</button>

            <br>
            <a class="text-primary" id="gotologin"> Đã có tài khoản? Đăng nhập ngay </a>
            </form>
      </div>


      <div class="loginformcard" id="maincard2">
      <h4> Đăng nhập vào tài khoản có sẵn</h4>
            ...
            <button class="formbtn" name="loginsubmit" type="submit">Đăng nhập</button>

            <br>
            <a class="text-primary" id="gotosignup"> Không có tài khoản? Đăng ký ngay</a>
            </form>
